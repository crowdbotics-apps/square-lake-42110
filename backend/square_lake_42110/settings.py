"""
Django settings for square_lake_42110 project.
...
ROOT_URLCONF = 'square_lake_42110.urls'
...
WSGI_APPLICATION = 'square_lake_42110.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_lake_42110 API",
    "DESCRIPTION": "API documentation for square_lake_42110 App",
    "VERSION": "v1",
}
